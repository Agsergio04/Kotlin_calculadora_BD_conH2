...
class  Controlador(
    ...
    private fun procesarArgumentos(args: Array<String>): Boolean {
        val ruta = when (args.size) {
            ...
            1, 4 -> args[0]
                ...
                ui.mostrarError("Numero de argumentos invalido. Esperado: 0, 1 o 4.")
                return false
            }
        }
    ...
    private fun mostrarInfo(lineas: List<String>) {
        if (lineas.isEmpty()) {
            ui.mostrar("No existe informacion de un log previo!")
        } else {
            ui.mostrar("Contenido del log mas reciente:")
    ...
    private fun ejecutarCalculoConArgumentos(args: Array<String>) {
        ...
        if (numero1 == null || operador == null || numero2 == null) {
            val msg = "Error en los argumentos: operacion no valida."
            ui.mostrarError(msg)
    ...
    private fun bucleCalculosUsuario() {
        do {
            try {
                val numero1 = ui.pedirDouble("Introduce el primer numero: ") ?: throw InfoCalcException("El primer número no es válido!")
                ...
                val numero2 = ui.pedirDouble("Introduce el segundo numero: ") ?: throw InfoCalcException("El segundo número no es válido!")
